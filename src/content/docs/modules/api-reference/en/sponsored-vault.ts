...
- Before sponsoring in **restricted** mode, read \`open\` via GET or SDK; if \`false\`, ensure the sponsor is the contract admin or has been added with **add-sponsor** (on-chain admin tx).
