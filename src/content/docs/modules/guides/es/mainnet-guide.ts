...
|--------|---------|---------|
| URL base | \`https://api.testnet.acta.build\` | \`https://api.mainnet.acta.build\` |
...
- **Swagger es solo de testnet**: \`https://api.mainnet.acta.build/docs\` devuelve 404 por diseño. Explora en testnet; las rutas son idénticas.
